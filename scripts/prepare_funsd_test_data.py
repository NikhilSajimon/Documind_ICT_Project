...
JSON_DIR = 'data/raw/funsd/dataset/testing_data/annotations'
IMAGE_DIR = 'data/raw/funsd/dataset/testing_data/images' 
PROCESSED_FILE = 'data/processed/funsd_test_aligned_data.pkl'
